...
public class ConversionContext {
  ...
  public String getLowercase(String wordToLowercase) {
    ...
    if (!wordToLowercase.endsWith("s")) {
      wordToLowercase = new StringBuilder(wordToLowercase).append('s').toString();
    }
  ...
  public String getCapitalized(String wordToCapitalize) {
    ...
    wordToCapitalize =
        Character.toUpperCase(wordToCapitalize.charAt(0)) + wordToCapitalize.substring(1);
